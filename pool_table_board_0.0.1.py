...
class BallSprite:
    ...
    def apply_scale(self, scale: float):
        ...
        # Avoid creating degenerate images
...
class PoolTableCanvas(tk.Frame):
    ...
    def set_ball_scale(self, scale: float):
        ...
        for b in self.balls:
            # Re-render at the new scale without changing center position
            b.apply_scale(scale)
    ...
    def restore(self, data: Dict):
        ...
        # Apply saved scale first (default 1.0)
...
class Sidebar(tk.Frame):
    """
    Right pane: controls for loading images, toggling ball visibility, and ball size slider.
    """
...
class App(tk.Tk):
    def __init__(self):
        ...
        self.sidebar = Sidebar(self, self.table_canvas, width=260, bd=1, relief="groove")
